...
# Memuat dataset
day_df = pd.read_csv('https://raw.githubusercontent.com/ZeroAce25/Proyek-Analisis-Data-Dicoding/refs/heads/main/dashboard/day.csv?token=GHSAT0AAAAAACYLT5WCUJSQYVVRJNOOCBNCZX5NWFQ')  
